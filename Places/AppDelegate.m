...
#define API_KEY @"AIzaSyDZ3inlDoHvfOQwdp-UjHoIsZadTLNcOTg"
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.qualitance.Places" in the application's documents directory.
